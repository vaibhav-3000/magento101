...
class Interceptor extends \Magento\Widget\Block\Adminhtml\Widget\Instance\Edit\Tab\Settings implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getWidgetInstance');
        return $pluginInfo ? $this->___callPlugins('getWidgetInstance', func_get_args(), $pluginInfo) : parent::getWidgetInstance();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getContinueUrl');
        return $pluginInfo ? $this->___callPlugins('getContinueUrl', func_get_args(), $pluginInfo) : parent::getContinueUrl();
    }
    ...
    public function getTypesOptionsArray()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getTypesOptionsArray', func_get_args(), $pluginInfo) : parent::getTypesOptionsArray();
    }
